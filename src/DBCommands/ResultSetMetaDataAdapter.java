...
public class ResultSetMetaDataAdapter implements java.sql.ResultSetMetaData {
	...
	ResultSetMetaDataImplementation rsmd;
	
	public ResultSetMetaDataAdapter(String databaseName, String tableName) {
		rsmd = new ResultSetMetaDataImplementation(databaseName, tableName);
	}
	@Override
